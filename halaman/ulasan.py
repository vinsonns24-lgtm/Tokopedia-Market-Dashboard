...
with panel:
    ...
    with st.container(key="kartu-model"):
        ...
        st.caption(f"Diuji dengan {angka(metrik['data_uji'])} ulasan yang tidak pernah dilihat saat latihan.")
        k1, k2 = st.columns(2)
...
Keterbatasan: label berasal dari rating, dan data latih berasal dari tahun 2019 dengan ulasan negatif yang didominasi kategori handphone. Proses lengkapnya ada di notebook `06_model_sentimen.ipynb`.
"""
            )
